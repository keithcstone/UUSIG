...
- - -
**CACHECHK** ([1082](1082/1082.md), July
...
handling; and both text and bit-oriented I/O. The CALL processor is a combined compiler and execution environment,capable of running CALL
...
**CHECK** ([1067](1067/1067.md), February
...
**CHGSPC** ([1072](1072/1072.md), December
...
**CHKBACK/FAS** ([1065](1065/1065.md), May
...
**COBOL** ([1077](1077/1077.md), May
1990![](IMAGES/OS2200.JPG)) - An ASCII COBOL compiler caller.(IPF)


**COMPARE** ([1081](1081/1081.md), February
1993![](IMAGES/OS2200.JPG)) - Used to validate that the system clocks are correct after the processors have been stopped for more than a day.(ELT)


**COMPILE** ([1077](1077/1077.md), May
1990![](IMAGES/OS2200.JPG)) - A full-screen compiler organizer.(IPF)


**COMPILER** ([1077](1077/1077.md), May
1990![](IMAGES/OS2200.JPG)) - Same as the COMPILE procedure.(IPF)


**COMPILERS** ([1077](1077/1077.md), May
1990![](IMAGES/OS2200.JPG)) - Same as the COMPILE procedure.(IPF)


**COMPRESS** ([1102](1102/1102.md) ,October
1995 ![[ASeries]](IMAGES/ASERIES.JPG)) - A Series port on Unix compress program.
(ALGOL)


**COND** ([1051](1051/1051.md), May 1980![](IMAGES/OS2200.JPG)) - Program description not available. (ASM,ABS)


**CONFG$** ([1084](1084/1084.md), November
...
**CONFR** ([1051](1051/1051.md), May
1982![](IMAGES/OS2200.JPG)) - The @CONFR processor permits two or more demand users to converse with one another, or to leave messages or memoranda, for one another. This program was designed to operate with ISD's account number and userid conventions, and will probably
require modifications to work properly at another site. Documentation
included. (ABS)


**CONLST** ([1051](1099/1099.md), September
...
**CONS** ([1084](1084/1084.md), January
...
**CONSOLE-CCR** ([1051](1051/1051.md), May
1982![](IMAGES/OS2200.JPG)) - Program description not available.(MSM 1982,
ABS 1981).


**CONVERT** ([1067](1067/1067.md), May
...
**CONVERT** ([1097](1097/1097.md), July
...
**COPYW** ([1097](1097/1097.md), January
1985![](IMAGES/OS2200.JPG)) - Used to copy OS1100 Word-Addressable files to and from magnetic tape. SLC CSF does not have the source for this program so it is being supplied as Absolute-Only. No documentation is available for this program. (ABS)


**COPYWAD** ([1097](1097/1097.md), February
...
**CPA** ([1081](1081/1081.md), September
...
**CPD** ([1042](1042/1042.md), May 1980![](IMAGES/OS2200.JPG)) - COPY-DUMP is an enhancement of the DPDMPH
...
**CPMD** ([1067](1067/1067.md), February
...
its core image is dumped by the 1100 EXECUTIVE to a file for possible post-processing. CPMD is a program to selectively examine this dump
interactively. Register dumps and dumps in specified formats (such as integer or INSTRUCTION) are allowed. CPMD normally looks at the
...
**CSHELL** ([1097](1097/1097.md), September
...
including: 
- ALIASING: This allows one to alias any command or multiple commands to a new command name of their choice. 
- HISTORY
BUFFER: Each command which is entered is saved in a buffer and can be displayed or reexecuted at any point. 
- REDIRECTION: An easy way to redirect the output of any command or multiple commands to a file or
element. 
- PIPES: Used to redirect the output from one command as
input to another file. 
- SEARCHPATH: One can define a path of program
files to search for a particular processor to execute (similar to
paths used by UNIX and MS-DOS). 
- And much much more including
- internal processors such as the decimal/octal calculator, GREP (used to search for strings), SCRIPTS, and extensive documentation. (SYM, ABS)


**CTABS** ([1072](1072/1072.md), November
1989![](IMAGES/OS2200.JPG)) - Set COBOL tab positions for use with";".
(IPF)


**CU1** ([1081](1081/1081.md), January
1992![](IMAGES/OS2200.JPG)) - Editor macro used to convert the current line
to uppercase. (ELT)


**CVTASC/CVTIBM** ([1065](1065/1065.md),
...
**CYC** ([1099](1099/1099.md), September
...
**CYCLE** ([1077](1077/1077.md), May
1990![](IMAGES/OS2200.JPG)) - Works like the @CYCLE ECL command.(IPF)


**CYCLES** ([1081](1081/1081.md), April
1993![](IMAGES/OS2200.JPG)) - Utility for printing a summary of a file's F-cycles. Documentation included. (MSM, ABS)
